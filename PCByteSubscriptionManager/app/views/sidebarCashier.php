...
<div id="sidebar" class="sidebar fixed left-4 top-[150px] z-10 bg-white rounded-[20px] shadow-lg p-4 cursor-pointer w-[80px] transition-all duration-300 overflow-hidden">
    <div class="flex flex-col items-start space-y-6">
        ...
        <a class="sidebar-btn flex items-center space-x-3 p-2 w-full" href="<?php echo ROOT?>cashier">
        ...
        <a class="sidebar-btn flex items-center space-x-3 p-2 w-full" href="<?php echo ROOT?>customers">
            <i class="fas fa-users text-2xl text-gray-600"></i>
            <span class="sidebar-text text-gray-700 font-medium hidden" >Customers</span>
        </a>
        <a class="sidebar-btn flex items-center space-x-3 p-2 w-full" href="<?php echo ROOT?>transactions">
            <i class="fa-solid fa-money-bill text-2xl text-gray-600"></i>
            <span class="sidebar-text text-gray-700 font-medium hidden">Transaction</span>
        </a>
        <a class="sidebar-btn flex items-center space-x-3 p-2 w-full" href="<?php echo ROOT?>cashierProfile">
